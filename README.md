...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://dev-api.stackbit.com/pull/5ff357914c80b00015506aad
...
To start editing your site, you can use the Sanity interface at https://spectacular-goat-35791.sanity.studio/.
...
Generated at `2021-01-04T18:00:05.992Z` by Stackbit version `0.3.42`.